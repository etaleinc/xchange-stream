...
public class HuobiStreamingMarketDataServiceTest {

    @Mock
    private HuobiStreamingService huobiStreamingService;
    private HuobiStreamingMarketDataService marketDataService;

    @Before
    public void setUp() throws Exception {
        MockitoAnnotations.initMocks(this);
        marketDataService = new HuobiStreamingMarketDataService(huobiStreamingService);
    }
    ...
    public void testGetOrderBook() throws Exception {
        ...
        when(huobiStreamingService.subscribeChannel(any())).thenReturn(Observable.just(jsonNode));
